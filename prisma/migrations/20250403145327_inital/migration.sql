...
CREATE TABLE `blogs` (
    ...
    `bgColor` VARCHAR(45) NOT NULL DEFAULT '#FFFF',
...
-- AddForeignKey
ALTER TABLE `blog-users` ADD CONSTRAINT `blog-users_blogId_fkey` FOREIGN KEY (`blogId`) REFERENCES `blogs`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `blog-users` ADD CONSTRAINT `blog-users_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
